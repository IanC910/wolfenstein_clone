...
entity audio_hw_platform_wrapper is
  port (
    BCLK : out STD_LOGIC;
...
architecture STRUCTURE of audio_hw_platform_wrapper is
  component audio_hw_platform is
  port (
    BCLK : out STD_LOGIC;
    LRCLK : out STD_LOGIC;
    SDATA_O : out STD_LOGIC;
...
audio_hw_platform_i: component audio_hw_platform
     port map (
      BCLK => BCLK,
