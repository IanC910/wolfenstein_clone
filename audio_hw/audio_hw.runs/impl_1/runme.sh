...
HD_PWD='C:/Users/Ian/Projects/school/ensc452/wolfenstein_clone/audio_hw/audio_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_hw_platform_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_hw_platform_wrapper.tcl -notrace
