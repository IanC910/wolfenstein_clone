...
synth_design -top wolfenstein_platform_PmodJSTK2_1_0 -part xc7z020clg484-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix wolfenstein_platform_PmodJSTK2_1_0_ wolfenstein_platform_PmodJSTK2_1_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wolfenstein_platform_PmodJSTK2_1_0_stub.v
 lappend ipCachedFiles wolfenstein_platform_PmodJSTK2_1_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wolfenstein_platform_PmodJSTK2_1_0_stub.vhdl
 lappend ipCachedFiles wolfenstein_platform_PmodJSTK2_1_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wolfenstein_platform_PmodJSTK2_1_0_sim_netlist.v
 lappend ipCachedFiles wolfenstein_platform_PmodJSTK2_1_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wolfenstein_platform_PmodJSTK2_1_0_sim_netlist.vhdl
 lappend ipCachedFiles wolfenstein_platform_PmodJSTK2_1_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp wolfenstein_platform_PmodJSTK2_1_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips wolfenstein_platform_PmodJSTK2_1_0]
 }
...
rename_ref -prefix_all wolfenstein_platform_PmodJSTK2_1_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef wolfenstein_platform_PmodJSTK2_1_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "wolfenstein_platform_PmodJSTK2_1_0_synth_1_synth_report_utilization_0" "report_utilization -file wolfenstein_platform_PmodJSTK2_1_0_utilization_synth.rpt -pb wolfenstein_platform_PmodJSTK2_1_0_utilization_synth.pb"
...
OPTRACE "wolfenstein_platform_PmodJSTK2_1_0_synth_1" END { }
