...
synth_design -top audio_hw_platform_wrapper -part xc7z020clg484-1
...
write_checkpoint -force -noxdef audio_hw_platform_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file audio_hw_platform_wrapper_utilization_synth.rpt -pb audio_hw_platform_wrapper_utilization_synth.pb"
