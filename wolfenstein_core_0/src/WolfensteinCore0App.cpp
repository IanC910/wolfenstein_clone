...
void WolfensteinCore0App::handleUserMovement() {
	...
	if(DO_USE_JOYSTICKS) {
		moveCtrlX = mapJSTK(jstkPosition2.XData);
		moveCtrlY = mapJSTK(jstkPosition2.YData);
		turnCtrl = mapJSTK(jstkPosition1.XData);
	}
	else {
