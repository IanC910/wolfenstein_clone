...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of audio_fetcher_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins audio_fetcher_0/S_AXI]
	connect_bd_net [get_bd_pins audio_fetcher_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins audio_fetcher_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of audio_fetcher_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins audio_fetcher_0/M_AXI_AUDIO_OUT]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_audio_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_audio_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_audio_out_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_audio_out_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_audio_out_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins audio_fetcher_0/M_AXI_DMA]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_dma_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_dma_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_dma_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_dma_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins audio_fetcher_0/m_axi_dma_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of audio_fetcher_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {audio_fetcher_0/M_AXI_AUDIO_OUT/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {audio_fetcher_0/M_AXI_DMA/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_AUDIO_OUT_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M_AXI_DMA_TARGET_SLAVE_BASE_ADDR {0xC0000100} ] [get_bd_cells audio_fetcher_0]

	# Copy all address to audio_fetcher_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/audio_fetcher_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_audio_fetcher_0_S_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/audio_fetcher_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "audio_fetcher_v1_0_hw_${i}"
