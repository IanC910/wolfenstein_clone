...
ISEStep( "vivado",
         "-log audio_hw_platform_zed_audio_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_hw_platform_zed_audio_ctrl_0_1.tcl" );
