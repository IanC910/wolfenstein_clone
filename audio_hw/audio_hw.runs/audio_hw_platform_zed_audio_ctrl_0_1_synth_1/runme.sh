...
HD_PWD='C:/Users/Ian/Projects/school/ensc452/wolfenstein_clone/audio_hw/audio_hw.runs/audio_hw_platform_zed_audio_ctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_hw_platform_zed_audio_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_hw_platform_zed_audio_ctrl_0_1.tcl
