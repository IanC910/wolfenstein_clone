...
static Level level0(LEVEL_0_WIDTH, LEVEL_0_HEIGHT, LEVEL_0_NUM_ENEMIES, LEVEL_0_NUM_HEALTH_DROPS, LEVEL_0_STARTING_X, LEVEL_0_STARTING_Y, LEVEL_0_ENEMY_POSITIONS, LEVEL_0_HEALTH_DROP_POSITIONS, LEVEL_0_LAYOUT);
...
float LEVEL_1_ENEMY_POSITIONS[MAX_NUM_HEALTH_DROPS][2] = {
	{0.5, 3.5},
	{13.5, 6.0},
	{6.5, 7.5},
	{4.5, 7.5},
...
float LEVEL_1_HEALTH_DROP_POSITIONS[MAX_NUM_ENEMIES][2] = {
	{0.5, 0.5},
	{2.5, 13.5},
	{14.5, 11.5}
};
...
static Level level1(LEVEL_1_WIDTH, LEVEL_1_HEIGHT, LEVEL_1_NUM_ENEMIES, LEVEL_1_NUM_HEALTH_DROPS, LEVEL_1_STARTING_X, LEVEL_1_STARTING_Y, LEVEL_1_ENEMY_POSITIONS, LEVEL_1_HEALTH_DROP_POSITIONS, LEVEL_1_LAYOUT);
