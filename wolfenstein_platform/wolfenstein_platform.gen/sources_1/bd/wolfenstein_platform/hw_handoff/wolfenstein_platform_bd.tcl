...
################################################################
# This is a generated script based on design: wolfenstein_platform
#
...
# source wolfenstein_platform_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# audio_fetcher, btn_interrupt_gen, debouncer
...
set design_name wolfenstein_platform
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set audio_fetcher_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.ZED_AUDIO_CTRL_ADDR {1136721920} \
 ] $audio_fetcher_0
  ...
  # Create instance: axi_mem_intercon_audio, and set properties
  set axi_mem_intercon_audio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon_audio ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $axi_mem_intercon_audio

  # Create instance: axi_mem_intercon_vga, and set properties
  set axi_mem_intercon_vga [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon_vga ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $axi_mem_intercon_vga

  # Create instance: btn_interrupt_gen_0, and set properties
  set block_name btn_interrupt_gen
  set block_cell_name btn_interrupt_gen_0
  if { [catch {set btn_interrupt_gen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $btn_interrupt_gen_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {15.873016} \
  ...
  # Create instance: slice_debug, and set properties
  set slice_debug [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_debug ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DOUT_WIDTH {8} \
 ] $slice_debug
  ...
  connect_bd_intf_net -intf_net audio_fetcher_0_m_axi_dma [get_bd_intf_pins audio_fetcher_0/m_axi_dma] [get_bd_intf_pins axi_mem_intercon_audio/S00_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_1_M00_AXI [get_bd_intf_pins axi_mem_intercon_audio/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon_vga/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins btn_interrupt_gen_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net vga_controller_0_M_AXI [get_bd_intf_pins axi_mem_intercon_vga/S00_AXI] [get_bd_intf_pins vga_controller_0/M_AXI]

  # Create port connections
  connect_bd_net -net audio_fetcher_0_debug_data_o [get_bd_pins audio_fetcher_0/debug_data_o] [get_bd_pins slice_debug/Din]
  connect_bd_net -net btn_interrupt_gen_0_interrupt [get_bd_pins btn_interrupt_gen_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  connect_bd_net -net rst_ps7_0_200M_peripheral_aresetn [get_bd_pins PmodJSTK2_0/s_axi_aresetn] [get_bd_pins PmodJSTK2_1/s_axi_aresetn] [get_bd_pins audio_fetcher_0/m_axi_audio_out_aresetn] [get_bd_pins audio_fetcher_0/m_axi_dma_aresetn] [get_bd_pins audio_fetcher_0/s_axi_aresetn] [get_bd_pins axi_gpio_i2c_addr/s_axi_aresetn] [get_bd_pins axi_mem_intercon_audio/ARESETN] [get_bd_pins axi_mem_intercon_audio/M00_ARESETN] [get_bd_pins axi_mem_intercon_audio/S00_ARESETN] [get_bd_pins axi_mem_intercon_vga/ARESETN] [get_bd_pins axi_mem_intercon_vga/M00_ARESETN] [get_bd_pins axi_mem_intercon_vga/S00_ARESETN] [get_bd_pins btn_interrupt_gen_0/s00_axi_aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps7_0_200M/peripheral_aresetn] [get_bd_pins vga_controller_0/rstn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  connect_bd_net -net slice_debug_Dout [get_bd_ports leds] [get_bd_pins slice_debug/Dout]
  ...
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces audio_fetcher_0/m_axi_audio_out] [get_bd_addr_segs btn_interrupt_gen_0/s00_axi/reg0] -force
  ...
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btn_interrupt_gen_0/s00_axi/reg0] -force
